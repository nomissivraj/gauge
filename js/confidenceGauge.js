window.addEventListener('DOMContentLoaded', function(event) {
    var name = "Value";
    var chart = document.querySelector('.confidenceChart-gauge');
    var value = parseInt(chart.dataset.currentconfidence, 10);
    var startValue = parseInt(chart.dataset.startingconfidence, 10);
    if (startValue < 5) {
        startValue = 5;
    } else if (startValue > 95) {
        startValue = 95;
    }
    ...
    var percentValueStart = startValue / gaugeMaxValue;
    ////////////////////////
    ...
    (function () {
        ...
        el = d3.select('.confidenceChart-gauge');
        margin = {
            top: 0,
            right: 20,
            bottom: 30,
